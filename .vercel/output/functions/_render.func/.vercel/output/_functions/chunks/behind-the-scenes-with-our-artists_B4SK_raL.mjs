const id = "behind-the-scenes-with-our-artists.md";
						...
						const data = {author:"dwight-schrute",categories:["studio tips"],date:"August 10, 2021",featured:false,image:
						new Proxy({"src":"/_astro/photoshoot.CS3kpkvt.jpg","width":5867,"height":3911,"format":"jpg","fsPath":"/Users/mattb/Desktop/Projects/Files/portfolio/src/content/posts/images/photoshoot.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/mattb/Desktop/Projects/Files/portfolio/src/content/posts/images/photoshoot.jpg";
							}
							
							return target[name];
						}
					})
					,title:"Behind-the-scenes with our artists",description:"lorem massa enim nec dui nunc mattis enim ut tellus elementum sagittis vitae"};
						const _internal = {
							type: 'content',
							filePath: "/Users/mattb/Desktop/Projects/Files/portfolio/src/content/posts/behind-the-scenes-with-our-artists.md",
							rawData: undefined,
						};
