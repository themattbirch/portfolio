const id = "creating-a-successful-music-brand.md";
						...
						const data = {author:"pam-beesely",categories:["career advice"],date:"August 10, 2021",featured:false,image:
						new Proxy({"src":"/_astro/record.CRzfKz-P.jpg","width":3000,"height":2000,"format":"jpg","fsPath":"/Users/mattb/Desktop/Projects/Files/portfolio/src/content/posts/images/record.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/mattb/Desktop/Projects/Files/portfolio/src/content/posts/images/record.jpg";
							}
							
							return target[name];
						}
					})
					,title:"Creating a successful music brand",description:"lorem massa enim nec dui nunc mattis enim ut tellus elementum sagittis vitae"};
						const _internal = {
							type: 'content',
							filePath: "/Users/mattb/Desktop/Projects/Files/portfolio/src/content/posts/creating-a-successful-music-brand.md",
							rawData: undefined,
						};
