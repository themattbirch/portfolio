const id = "collaboration-in-music-production.md";
						...
						const data = {author:"michael-scott",categories:["studio tips"],date:"August 10, 2021",featured:false,image:
						new Proxy({"src":"/_astro/band.CMKc0NPe.jpg","width":4752,"height":3168,"format":"jpg","fsPath":"/Users/mattb/Desktop/Projects/Files/portfolio/src/content/posts/images/band.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/mattb/Desktop/Projects/Files/portfolio/src/content/posts/images/band.jpg";
							}
							
							return target[name];
						}
					})
					,title:"Collaboration in music production",description:"lorem massa enim nec dui nunc mattis enim ut tellus elementum sagittis vitae"};
						const _internal = {
							type: 'content',
							filePath: "/Users/mattb/Desktop/Projects/Files/portfolio/src/content/posts/collaboration-in-music-production.md",
							rawData: undefined,
						};
