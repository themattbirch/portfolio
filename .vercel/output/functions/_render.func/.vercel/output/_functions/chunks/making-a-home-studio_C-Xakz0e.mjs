const id = "making-a-home-studio.md";
						...
						new Proxy({"src":"/_astro/studio.LDnkyfMd.jpg","width":6720,"height":4480,"format":"jpg","fsPath":"/Users/mattb/Desktop/Projects/Files/portfolio/src/content/posts/images/studio.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/mattb/Desktop/Projects/Files/portfolio/src/content/posts/images/studio.jpg";
							}
							
							return target[name];
						}
					})
					,title:"Making a home studio",description:"lorem massa enim nec dui nunc mattis enim ut tellus elementum sagittis vitae"};
						const _internal = {
							type: 'content',
							filePath: "/Users/mattb/Desktop/Projects/Files/portfolio/src/content/posts/making-a-home-studio.md",
							rawData: undefined,
						};
