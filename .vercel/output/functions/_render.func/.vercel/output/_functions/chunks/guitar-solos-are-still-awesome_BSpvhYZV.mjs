const id = "guitar-solos-are-still-awesome.md";
						...
						const data = {author:"jim-halpert",categories:["career advice"],date:"August 10, 2021",featured:false,image:
						new Proxy({"src":"/_astro/guitarist.B83iMcFz.jpg","width":6000,"height":4000,"format":"jpg","fsPath":"/Users/mattb/Desktop/Projects/Files/portfolio/src/content/posts/images/guitarist.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/mattb/Desktop/Projects/Files/portfolio/src/content/posts/images/guitarist.jpg";
							}
							
							return target[name];
						}
					})
					,title:"Guitar solos are still awesome",description:"lorem massa enim nec dui nunc mattis enim ut tellus elementum sagittis vitae"};
						const _internal = {
							type: 'content',
							filePath: "/Users/mattb/Desktop/Projects/Files/portfolio/src/content/posts/guitar-solos-are-still-awesome.md",
							rawData: undefined,
						};
