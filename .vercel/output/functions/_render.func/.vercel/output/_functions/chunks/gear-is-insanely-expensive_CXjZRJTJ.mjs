const id = "gear-is-insanely-expensive.md";
						...
						const data = {author:"dwight-schrute",categories:["career advice"],date:"August 10, 2021",featured:false,image:
						new Proxy({"src":"/_astro/gear.CFQSK5TA.jpg","width":5184,"height":3456,"format":"jpg","fsPath":"/Users/mattb/Desktop/Projects/Files/portfolio/src/content/posts/images/gear.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/mattb/Desktop/Projects/Files/portfolio/src/content/posts/images/gear.jpg";
							}
							
							return target[name];
						}
					})
					,title:"Gear is insanely expensive",description:"lorem massa enim nec dui nunc mattis enim ut tellus elementum sagittis vitae"};
						const _internal = {
							type: 'content',
							filePath: "/Users/mattb/Desktop/Projects/Files/portfolio/src/content/posts/gear-is-insanely-expensive.md",
							rawData: undefined,
						};
