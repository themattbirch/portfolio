const id = "live-music-is-crucial.md";
						...
						const data = {author:"jim-halpert",categories:["insights"],date:"August 10, 2021",featured:false,image:
						new Proxy({"src":"/_astro/concert.CSJ1K1HT.jpg","width":5760,"height":3840,"format":"jpg","fsPath":"/Users/mattb/Desktop/Projects/Files/portfolio/src/content/posts/images/concert.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/mattb/Desktop/Projects/Files/portfolio/src/content/posts/images/concert.jpg";
							}
							
							return target[name];
						}
					})
					,title:"Live music is crucial",description:"lorem massa enim nec dui nunc mattis enim ut tellus elementum sagittis vitae"};
						const _internal = {
							type: 'content',
							filePath: "/Users/mattb/Desktop/Projects/Files/portfolio/src/content/posts/live-music-is-crucial.md",
							rawData: undefined,
						};
