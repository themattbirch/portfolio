const id = "the-art-of-music-production.md";
						...
						const data = {author:"michael-scott",categories:["latest","insights"],date:"August 10, 2021",featured:true,image:
						new Proxy({"src":"/_astro/producer.BL9OIBzv.jpg","width":3841,"height":2560,"format":"jpg","fsPath":"/Users/mattb/Desktop/Projects/Files/portfolio/src/content/posts/images/producer.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/mattb/Desktop/Projects/Files/portfolio/src/content/posts/images/producer.jpg";
							}
							
							return target[name];
						}
					})
					,title:"The art of music production",description:"lorem massa enim nec dui nunc mattis enim ut tellus elementum sagittis vitae"};
						const _internal = {
							type: 'content',
							filePath: "/Users/mattb/Desktop/Projects/Files/portfolio/src/content/posts/the-art-of-music-production.md",
							rawData: undefined,
						};
